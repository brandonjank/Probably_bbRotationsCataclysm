-- SPEC ID 63
ProbablyEngine.rotation.register_custom(63, "bbFireMage", {
...
function()
	...
	ProbablyEngine.toggle.create('mouseovers', 'Interface\\Icons\\ability_mage_livingbomb', 'Toggle Mouseovers', 'Automatically cast spells on mouseover targets')
end)
